...
#UPDATE flight
curl -X PUT -i -H "Content-Type: application/json" --data '{"international":true,"departure":"24784728","arrival":"247849357","airplane":{"name":"Boeing 747 Jumbo","type":"ECONOMY","capacity":600,"id":1},"from":{"name":"SHA","city":"Shanghai","country":"China","id":1},"to":{"name":"KAR","city":"Karachi","country":"Pakistan","id":2},"id":2}' http://localhost:8080/pa165/rest/flights/updateFlight

#DELETE flight
curl -i -X DELETE  http://localhost:8080/pa165/rest/flights/deleteFlight/1

#Add steward
curl -i -X PUT  http://localhost:8080/pa165/rest/flights/addSteward/1/-21474836480

#Remove steward
curl -i -X PUT  http://localhost:8080/pa165/rest/flights/removeSteward/1/-21474836480
